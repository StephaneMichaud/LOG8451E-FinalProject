...
aws s3 cp s3://{s3_bucket_name}/instances_assets/db_instance/db_manager/requirements.txt ./requirements.txt
sudo pip3 install -r requirements.txt


# Run flask application
aws ec2 create-tags --region {region} --resources $instance_id --tags Key=STATUS,Value=READY
aws s3 cp s3://{s3_bucket_name}/instances_assets/db_instance/db_manager/main.py ./main.py
sudo python3 main.py
"""

import os
def get_db_manager_data(s3_bucket_name, benchmark_upload_path):
